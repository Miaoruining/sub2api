...
type PaymentOrder struct {
	...
	// SubscriptionCycleStart holds the value of the "subscription_cycle_start" field.
	...
	// SubscriptionAllowActiveRenewal holds the value of the "subscription_allow_active_renewal" field.
	SubscriptionAllowActiveRenewal bool `json:"subscription_allow_active_renewal,omitempty"`
...
func (*PaymentOrder) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case paymentorder.FieldProviderSnapshot:
			values[i] = new([]byte)
		case paymentorder.FieldSubscriptionAllowActiveRenewal, paymentorder.FieldForceRefund:
			values[i] = new(sql.NullBool)
		case paymentorder.FieldAmount, paymentorder.FieldPayAmount, paymentorder.FieldFeeRate, paymentorder.FieldQuotaUsd, paymentorder.FieldRefundAmount:
		...
		case paymentorder.FieldSubscriptionCycleStart, paymentorder.FieldRefundAt, paymentorder.FieldRefundRequestedAt, paymentorder.FieldExpiresAt, paymentorder.FieldPaidAt, paymentorder.FieldCompletedAt, paymentorder.FieldFailedAt, paymentorder.FieldCreatedAt, paymentorder.FieldUpdatedAt:
...
func (_m *PaymentOrder) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case paymentorder.FieldSubscriptionCycleStart:
			if value, ok := values[i].(*sql.NullTime); !ok {
				return fmt.Errorf("unexpected type %T for field subscription_cycle_start", values[i])
			} else if value.Valid {
				_m.SubscriptionCycleStart = new(time.Time)
				*_m.SubscriptionCycleStart = value.Time
			}
		case paymentorder.FieldQuotaUsd:
			if value, ok := values[i].(*sql.NullFloat64); !ok {
		...
		case paymentorder.FieldSubscriptionAllowActiveRenewal:
			if value, ok := values[i].(*sql.NullBool); !ok {
				return fmt.Errorf("unexpected type %T for field subscription_allow_active_renewal", values[i])
			} else if value.Valid {
				_m.SubscriptionAllowActiveRenewal = value.Bool
			}
...
func (_m *PaymentOrder) String() string {
	...
	builder.WriteString(", ")
	if v := _m.SubscriptionCycleStart; v != nil {
		builder.WriteString("subscription_cycle_start=")
	...
	builder.WriteString(", ")
	builder.WriteString("subscription_allow_active_renewal=")
	builder.WriteString(fmt.Sprintf("%v", _m.SubscriptionAllowActiveRenewal))
	builder.WriteString(", ")
