    ...
    <template v-if="outcome === 'success'">
      <div class="card p-6">
        <div class="flex flex-col items-center space-y-4 py-4">
          ...
          <p class="text-lg font-bold text-gray-900 dark:text-white">{{ props.orderType === 'subscription' || props.orderType === 'subscription_topup' ? t('payment.result.subscriptionSuccess') : t('payment.result.success') }}</p>
