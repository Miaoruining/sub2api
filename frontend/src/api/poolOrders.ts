...
export interface PoolProduct {id: number; title: string; description: string; seats: number; price: number; duration_days: number; formation_days: number; total_tokens: number; total_requests: number; concurrency: number; status: 'active' | 'disabled'; version: number}
