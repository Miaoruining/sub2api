...
const routes: RouteRecordRaw[] = [
 { path:'/pool-orders/pricing',name:'PoolPricing',component:()=>import('@/views/user/PoolPricingView.vue'),meta:{requiresAuth:true,titleKey:'pool.pricingTitle',title:'Group billing rates'} },
 ...
 { path:'/admin/pool-resources',name:'PoolResources',component:()=>import('@/views/admin/PoolResourcesView.vue'),meta:{requiresAuth:true,requiresAdmin:true,titleKey:'pool.resourceTitle',title:'Group order accounts'} },
  ...
  },
  {
    ...
    meta: { requiresAuth: true, requiresAdmin: false, title: 'Daily lucky draw', titleKey: 'lottery.title', descriptionKey: 'lottery.description' }
  },
  {
    path: '/admin/lottery', name: 'AdminLottery',
    component: () => import('@/views/admin/LotteryView.vue'),
    meta: { requiresAuth: true, requiresAdmin: true, title: 'Draw management', titleKey: 'lottery.adminTitle', descriptionKey: 'lottery.adminDescription' }
  },
  {
    path: '/affiliate',
    name: 'Affiliate',
