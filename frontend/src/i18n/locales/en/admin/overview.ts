export default {
    ...
    groups: {
      ...
      sortOrder: 'Group Display Order',
      columnSettings: 'Column Settings',
      sortOrderHint: 'Controls display order only. Automatic keys use the user-selected smart, price or stability strategy.',
      sortOrderUpdated: 'Group display order updated',
      failedToUpdateSortOrder: 'Failed to update group display order',
