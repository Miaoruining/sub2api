export default {
    ...
    groups: {
      ...
      sortOrder: 'Auto Route Order',
      columnSettings: 'Column Settings',
      sortOrderHint: 'Drag groups to set the automatic cross-group attempt order. Requests only try healthy groups the user can access that support the target model; Model Plaza details show the same order.',
      sortOrderUpdated: 'Auto route order updated',
      failedToUpdateSortOrder: 'Failed to update auto route order',
