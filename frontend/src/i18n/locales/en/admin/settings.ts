export default {
    settings: {
      ...
      payment: {
        ...
        wxpaySignModePublicKey: 'WeChat Pay Public Key',
        wxpaySignModePlatformCertificate: 'Auto-rotating Platform Certificates',
        ...
        field_signMode: 'Signing Mode',
        field_signModeHint: 'Must match the signing mode configured for this App ID in Alipay Open Platform.',
        alipaySignModePublicKey: 'Public Key',
        alipaySignModeCertificate: 'Certificate',
        field_privateKey: 'Private Key',
        field_publicKey: 'Public Key',
        field_alipayPublicKeyHint: 'Enter the Alipay public key, not the application public key.',
        field_appCertPublicKey: 'Application Public Certificate',
        field_appCertPublicKeyHint: 'Paste the complete PEM content of appCertPublicKey_*.crt.',
        field_alipayCertPublicKey: 'Alipay Public Certificate',
        field_alipayCertPublicKeyHint: 'Paste the complete PEM content of alipayCertPublicKey_RSA2.crt.',
        field_alipayRootCert: 'Alipay Root Certificate',
        field_alipayRootCertHint: 'Paste the complete PEM content of alipayRootCert.crt.',
        field_mpAppId: 'MP App ID',
        field_mchId: 'Merchant ID',
        field_apiV3Key: 'API v3 Key',
        field_publicKeyId: 'Public Key ID',
        field_wxpaySignModeHint: 'Use the WeChat Pay public key for new merchants. Existing platform-certificate merchants can enable automatic platform certificate download and rotation without a public key or key ID.',
