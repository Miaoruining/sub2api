export default {
  ...
  payment: {
    ...
    basePlans: 'Subscription plans',
    quotaTopups: 'Quota top-ups',
    quotaTopup: 'Quota top-up',
    buyQuotaTopup: 'Buy quota',
    currentCycle: 'in current cycle',
    currentCycleExpires: 'This top-up expires at {expiresAt} ({days} days remaining).',
    topupRequiresActive: 'Requires an active subscription in this group.',
    activeBaseRequiresTopup: 'This active subscription cannot be renewed; use a quota top-up below.',
    quotaTopupsHint: 'Top-ups add quota to your active group subscription and expire with that 30-day cycle.',
    ...
    admin: {
      ...
      planKind: 'Plan Type',
      basePlan: 'Base subscription',
      quotaTopupPlan: 'Quota top-up',
      quotaUSD: 'Quota (USD)',
      quotaUSDHint: 'Added to the active subscription cycle; expires with it.',
      allowActiveRenewal: 'Allow active renewal',
      allowActiveRenewalHint: 'Legacy behavior only; new 30-day products should keep this off.',
