export default {
  ...
  keys: {
    ...
    copied: 'Copied!',
    importToCcSwitch: 'CC Switch import',
    ccSwitchGuide: {
      title: 'Import into CC Switch',
      intro: 'Import this key and group configuration into CC Switch for your coding client.',
      provider: 'Provider name',
      endpoint: 'API endpoint',
      model: 'Default model',
      loading: 'Loading this group’s model catalog…',
      modelError: 'Could not load the model catalog. Retry or enter a model ID you have verified works.',
      inactive: 'This key is unavailable. Check its status, quota, and expiration first.',
      usage: 'Show wallet balance / plan allowance in CC Switch',
      usageHint: 'Queries this site with this key every 30 minutes. CC Switch shows the query script before import.',
      secretHint: 'This configuration contains your API key and is sent to CC Switch on your device. Do not share configurations or links containing keys.',
      stepsTitle: 'After importing',
      step1: 'Allow the browser to open CC Switch, review the configuration, and confirm the import.',
      step2: 'Enable the imported provider in the corresponding client tab. Importing does not automatically switch your current provider.',
      step3: 'Save your work, fully quit and reopen your coding client, then send a short message in a new task.',
      launched: 'Attempted to open CC Switch. Confirm inside the app. If it did not open, install it or use manual configuration below.',
      launchError: 'The browser could not open CC Switch. Check the installation or use manual configuration.',
      download: 'Download CC Switch (official; v3.20.1 or newer recommended)',
      manual: 'Manual configuration',
      import: 'Import into CC Switch'
    },
    enable: 'Enable',
    disable: 'Disable',
    nameLabel: 'Name',
  ...
  modelPlaza: {
    ...
    detail: {
      ...
      longContextDisabledNote: 'Long-context tier pricing is disabled for this group: requests above the threshold are billed at the base tier; official tiers are for reference only', modelRateNote: 'Rates inherited per source model'
    },
    table: {
      model: 'Model',
      input: 'Input',
