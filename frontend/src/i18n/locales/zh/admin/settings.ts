export default {
    settings: {
      ...
      payment: {
        ...
        providerWxpay: '微信官方',
        wxpaySignModePublicKey: '微信支付公钥',
        wxpaySignModePlatformCertificate: '平台证书自动轮换',
        ...
        field_signMode: '签名模式',
        field_signModeHint: '需与支付宝开放平台该 App ID 配置的接口加签方式一致。',
        alipaySignModePublicKey: '普通公钥',
        alipaySignModeCertificate: '证书',
        field_privateKey: '私钥',
        field_publicKey: '公钥',
        field_alipayPublicKeyHint: '填写支付宝公钥，不是应用公钥。',
        field_appCertPublicKey: '应用公钥证书',
        field_appCertPublicKeyHint: '粘贴 appCertPublicKey_*.crt 的完整 PEM 内容。',
        field_alipayCertPublicKey: '支付宝公钥证书',
        field_alipayCertPublicKeyHint: '粘贴 alipayCertPublicKey_RSA2.crt 的完整 PEM 内容。',
        field_alipayRootCert: '支付宝根证书',
        field_alipayRootCertHint: '粘贴 alipayRootCert.crt 的完整 PEM 内容。',
        field_mpAppId: '公众号 App ID',
        field_mchId: '商户号',
        field_apiV3Key: 'API v3 密钥',
        field_publicKeyId: '公钥 ID',
        field_wxpaySignModeHint: '新商户推荐使用微信支付公钥；已有平台证书商户可选择自动下载和轮换平台证书，无需填写微信支付公钥及公钥 ID。',
