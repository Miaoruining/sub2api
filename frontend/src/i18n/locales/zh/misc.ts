export default {
  ...
  payment: {
    ...
    buyQuotaTopup: '购买额度',
    currentCycle: '当前周期内',
    currentCycleExpires: '本额度包于 {expiresAt} 到期（剩余 {days} 天）。',
    topupRequiresActive: '需要先拥有本分组有效订阅。',
    activeBaseRequiresTopup: '当前订阅不可续期，请在下方购买本期额度包。',
    quotaTopupsHint: '额度包只增加当前分组订阅本周期额度，随该 30 天周期到期清零。',
    ...
    admin: {
      ...
      quotaTopupPlan: '额度包',
      quotaUSD: '额度（USD）',
      quotaUSDHint: '追加到当前订阅周期，随周期到期清零。',
      allowActiveRenewal: '允许有效期内续期',
      allowActiveRenewalHint: '仅用于兼容旧套餐；新的 30 天套餐应关闭。',
      createPlan: '创建套餐',
      editPlan: '编辑套餐',
      deletePlan: '删除套餐',
